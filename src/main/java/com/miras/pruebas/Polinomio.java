 ...
 */
public class Polinomio<E extends Number> implements Field<Polinomio<E>, E> {
...
*/
    ...
    public Polinomio<E> dif(Polinomio<E> other){
        ...
        for(int i = 0; i < MaxGrado; i++){
            try{
                Values[i] = (E) Field.restNum(this.values[i], other.values[i]);
            } catch(Exception Ex){
                try{
    ...
    @Override
    public Polinomio<E> multExt(E k) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
